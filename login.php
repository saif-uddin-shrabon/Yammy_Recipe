...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="YAMMY/css/coustom.css" />
    <style>
          .bg-image-vertical {
            position: relative;
            overflow: hidden;
    ...
    <div class="row">
      <div class="col-sm-6 text-black">
        ...
        <div class="px-5 ms-xl-4">
          ...
          <span class="h1 fw-bold mb-0">YAMMY</span>
        </div>

        <div class="d-flex align-items-center h-custom-2 px-5 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5">

          <form style="width: 23rem;" action="loginAction.php" method = "GET">
            ...
            <div class="pt-1 mb-4">
              <button class="btn btn-info btn-lg btn-block" type="loginAction">Login</button>
            </div>
